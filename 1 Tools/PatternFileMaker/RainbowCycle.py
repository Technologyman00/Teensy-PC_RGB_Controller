...
for hue in range(0, 360):
        for ii in range(0, 28):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(1*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(2*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(3*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(4*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(5*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(6*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(7*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(8*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(9*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 9):
                ...
                rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(10*incra))/res, 0.5, 1)
...
##                f.write((4).to_bytes(1, byteorder='big')) # Start Second Frame
        ...
        for ii in range(0, 8):
                        ...
                        rgb = colorsys.hls_to_rgb((hue+(ii*scale)+(11*incra))/res, 0.5, 1)
